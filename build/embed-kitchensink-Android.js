...
return (_4||[]).concat(Array.prototype.slice.call(_2,_3||0));
};
var _5=function(_6,_7,_8){
var _9=_8||[];
for(var x=_7||0;x<_6.length;x++){
_9.push(_6[x]);
}
return _9;
};
dojo._toArray=dojo.isIE?function(_a){
return ((_a.item)?_5:_1).apply(this,arguments);
}:_1;
})();
